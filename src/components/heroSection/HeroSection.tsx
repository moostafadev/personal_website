...
const HeroSection = () => {
  ...
  return (
    <section className="h-[calc(100vh-64px)] py-4 md:py-12 lg:py-16 xl:py-24 relative overflow-hidden">
      <div className="container relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4 lg:py-12 ">
        ...
        <div
          className={`absolute bottom-0 mb-[-40px] md:mb-0 z-10 ${
